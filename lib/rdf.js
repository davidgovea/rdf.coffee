(function() {
  ...
  global.rdf = (function() {
    ...
    rdf.BlankNode = (function() {
      ...
      BlankNode.prototype.interfaceName = 'BlankNode';
    ...
    rdf.NamedNode = (function() {
      ...
      NamedNode.prototype.interfaceName = 'NamedNode';
    ...
    rdf.Literal = (function() {
      function Literal(value, language, datatype, nativ) {
        ...
        this.h = language + '|' + (datatype ? datatype.toString() : '') + '|' + value.toString();
      ...
      Literal.prototype.interfaceName = 'Literal';
    ...
    rdf.Graph = (function() {
      ...
      Graph.prototype._graph = [];
      Graph.prototype._spo = {};
